...
import { getHomeProducts,addProductToCart } from '../api/apicalls'
...
// console.log('user',localStorage.getItem('user'));
    ...
    const addToCart=(cartproduct, userId)=>{
                            ...
                            <div className="col-md-3 col-sm-6" key={products._id}>
                                <div className="product-grid6">
                                    ...
                                    <ul className="social ">
                                        ...
                                        <li><a onClick={()=>addToCart(products,userId)} data-tip="Add to Cart"><i className="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                           );
